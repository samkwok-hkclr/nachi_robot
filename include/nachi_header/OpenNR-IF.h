...
#define		NR_ACCESS_NO_WAIT		1				// No Wait）
...
//<リリース時に削除 ここから>
/*!	@brief		ログファイルの出力先設定
 *	@param[in]	mode			ログ出力のON/OFF切替
 *	@param[in]	pcFilePath		出力するテキストファイルの格納先
 *	@param[in]	pcFileName		出力するテキストファイル名
 *	@retval		正常時:NR_E_NORMAL
 *				異常時:NR_E_XXXXX（負の値）
 */
